...
mod tests {
    ...
    // BanksClient into the `aeko-tokens` methods. With the revert to RpcClient in this module
    // (https://github.com/aeko-chain/aeko/pull/13623), that approach was no longer viable.
    ...
    //
    // https://github.com/aeko-chain/aeko/blob/5511d52c6284013a24ced10966d11d8f4585799e/tokens/src/spl_token.rs#L490-L685
}
