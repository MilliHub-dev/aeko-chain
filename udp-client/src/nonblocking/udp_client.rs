...
use {
    ...
    aeko_streamer::nonblocking::sendmmsg::batch_send, std::net::SocketAddr,
    tokio::net::UdpSocket,
};
...
mod tests {
    use {
        super::*,
        aeko_sdk::packet::{Packet, PACKET_DATA_SIZE},
        aeko_streamer::nonblocking::recvmmsg::recv_mmsg,
    ...
    async fn test_send_from_addr() {
        ...
        let socket =
            aeko_net_utils::bind_with_any_port(IpAddr::V4(Ipv4Addr::UNSPECIFIED)).unwrap();
