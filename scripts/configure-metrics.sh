# |source| this file
#
# The aeko_METRICS_CONFIG environment variable is formatted as a
# comma-delimited list of parameters. All parameters are optional.
#
# Example:
#   export aeko_METRICS_CONFIG="host=<metrics host>,db=<database name>,u=<username>,p=<password>"
#
...
configureMetrics() {
  [[ -n $aeko_METRICS_CONFIG ]] || return 0

  declare metricsParams
  IFS=',' read -r -a metricsParams <<< "$aeko_METRICS_CONFIG"
