...
mod tests {
    use {
        super::*,
        aeko_runtime::{bank::Bank, bank_client::BankClient},
        aeko_sdk::{
    ...
    fn test_new_derived_stake_account() {
        ...
        let stake_authority_pubkey = aeko_sdk::pubkey::new_rand();
        let withdraw_authority_pubkey = aeko_sdk::pubkey::new_rand();
    ...
    fn test_authorize_stake_accounts() {
        ...
        let new_stake_authority_pubkey = aeko_sdk::pubkey::new_rand();
        let new_withdraw_authority_pubkey = aeko_sdk::pubkey::new_rand();
