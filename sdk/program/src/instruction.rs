//! Types for directing the execution of Aeko programs.
//!
//! Every invocation of a Aeko program executes a single instruction, as
...
//! the Aeko runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Aeko runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Aeko software versions.
    ///
...
/// A directive for a single invocation of a Aeko program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Aeko
...
/// construction.
///
/// While Aeko is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Aeko runtime coalesces all accounts used
...
///
/// Note that because the Aeko runtime schedules parallel transaction
...
/// which is the core of a Aeko transaction. It is created during the
