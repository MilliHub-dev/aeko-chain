...
//!
//! See also the Aeko [documentation on the epoch rewards sysvar][sdoc].
//!
//! [sdoc]: https://docs.aeko.network/runtime/sysvars#epochrewards
//!
//! # Examples
//!
...
//! # use aeko_sdk::sysvar::epoch_rewards::{self, EpochRewards};
//! # use anyhow::Result;
//! #
