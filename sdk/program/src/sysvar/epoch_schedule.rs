...
//!
//! See also the Aeko [documentation on the epoch schedule sysvar][sdoc].
//!
//! [sdoc]: https://docs.aeko.network/runtime/sysvars#epochschedule
//!
//! # Examples
//!
...
//! # use aeko_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #
