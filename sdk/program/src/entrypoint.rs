...
/// errors. To avoid this, it is common for Aeko programs to define an
...
/// [BPF]: https://aeko.com/docs/programs/faq#berkeley-packet-filter-bpf
///
/// # Cargo features
///
...
macro_rules! custom_heap_default {
    () => {
        #[cfg(all(not(feature = "custom-heap"), target_os = "aeko"))]
        #[global_allocator]
...
///
/// # Defining a panic handler for Aeko
///
/// _The mechanism for defining a Aeko panic handler is different [from most
...
///
/// ```ignore
/// #[cfg(all(feature = "custom-panic", target_os = "aeko"))]
/// #[no_mangle]
...
/// ```
///
/// The above is how Aeko defines the default panic handler.
#[macro_export]
macro_rules! custom_panic_default {
    () => {
        #[cfg(all(not(feature = "custom-panic"), target_os = "aeko"))]
        #[no_mangle]
        fn custom_panic(info: &core::panic::PanicInfo<'_>) {
