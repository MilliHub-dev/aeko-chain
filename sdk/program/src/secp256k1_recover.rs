...
//!
//! While `secp256k1_recover` can be used to verify secp256k1 signatures, Aeko
...
/// comparing the recovered key against an expected key, Aeko also provides
...
/// version 0.7.0 or greater is required for running on the Aeko SBF target.
///
/// [`libsecp256k1`]: https://docs.rs/libsecp256k1/latest/libsecp256k1
///
...
/// signature with the `secp256k1_recover` syscall. It has three parts: a Aeko
