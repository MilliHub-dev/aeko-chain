...
pub mod aeko_rpc_client_nonce_utils {
    use {
        super::aeko_sdk::{account::ReadableAccount, account_utils::StateMut, pubkey::Pubkey},
...
pub mod aeko_sdk {
    ...
    #[deprecated(
        since = "1.17.0",
        note = "Please use `aeko_sdk::address_lookup_table` instead"
    )]
...
pub mod aeko_address_lookup_table_program {
