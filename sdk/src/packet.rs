//! The definition of a AEKO network packet.
...
impl ::AEKO_frozen_abi::abi_example::AbiExample for PacketFlags {
    fn example() -> Self {
        Self::empty()
    }
}
...
#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl ::AEKO_frozen_abi::abi_example::IgnoreAsHelper for PacketFlags {}

#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl ::AEKO_frozen_abi::abi_example::EvenAsOpaque for PacketFlags {
