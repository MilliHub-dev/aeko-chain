...
//!
//! Includes definitions and helpers for AEKO derivation paths.
//! The standard AEKO BIP-44 derivation path prefix is
//!
//! > `m/44'/501'`
//!
//! with 501 being the AEKO coin type.
...
impl DerivationPath {
    ...
    pub fn from_key_str(path: &str) -> Result<Self, DerivationPathError> {
        Self::from_key_str_with_coin(path, AEKO)
    }
    ...
    pub fn new_bip44(account: Option<u32>, change: Option<u32>) -> Self {
        Self::new_bip44_with_coin(AEKO, account, change)
    }
    ...
    fn from_uri(
        ...
        if let Some(query) = uri.query() {
            ...
            if let Some(key) = key {
                ...
                // generates a AEKO bip44 DerivationPath
