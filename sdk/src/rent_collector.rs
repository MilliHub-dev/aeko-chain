...
mod tests {
    use {
        ...
        aeko_sdk::{account::Account, sysvar},
    };
    ...
    fn test_collect_from_account_created_and_existing() {
        ...
        let collected = rent_collector
            .collect_from_created_account(&aeko_sdk::pubkey::new_rand(), &mut created_account);
        ...
        let collected = rent_collector
            .collect_from_existing_account(&aeko_sdk::pubkey::new_rand(), &mut existing_account);
