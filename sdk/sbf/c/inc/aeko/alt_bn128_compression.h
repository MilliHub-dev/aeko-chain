#pragma once
/**
 * @brief AEKO bn128 elliptic curve compression and decompression
**/
 ...
 */
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/sbf/c/inc/aeko/inc/alt_bn128_compression.inc AND RUN `cargo run --bin gen-headers` */
#ifndef aeko_SBFV2
uint64_t aeko_alt_bn128_compression(
        const uint64_t op,
        const uint8_t *input,
...
#else
typedef uint64_t(*aeko_alt_bn128_compression_pointer_type)(
        const uint64_t op,
        const uint8_t *input,
        const uint64_t input_size,
        uint8_t *result
);
static uint64_t aeko_alt_bn128_compression(
        const uint64_t op arg1,
        const uint8_t *input arg2,
        const uint64_t input_size arg3,
        uint8_t *result
 arg4) {
  aeko_alt_bn128_compression_pointer_type aeko_alt_bn128_compression_pointer = (aeko_alt_bn128_compression_pointer_type) 860870125;
  return aeko_alt_bn128_compression_pointer(arg1, arg2, arg3, arg4);
}
#endif
