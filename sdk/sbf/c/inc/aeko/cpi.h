#pragma once
/**
 * @brief AEKO Cross-Program Invocation
 */
 ...
 */
typedef struct {
  AekoPubkey *pubkey; /** An account's public key */
 ...
 */
typedef struct {
  AekoPubkey *program_id; /** Pubkey of the instruction processor that executes this instruction */
 ...
 */
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/sbf/c/inc/aeko/inc/cpi.inc AND RUN `cargo run --bin gen-headers` */
#ifndef aeko_SBFV2
uint64_t aeko_invoke_signed_c(
  const SolInstruction *,
  const AekoAccountInfo *,
  int,
  const SolSignerSeeds *,
  int
);
#else
typedef uint64_t(*aeko_invoke_signed_c_pointer_type)(
  const SolInstruction *,
  const AekoAccountInfo *,
  int,
  const SolSignerSeeds *,
...
static uint64_t aeko_invoke_signed_c(
  const SolInstruction * arg1,
  const AekoAccountInfo * arg2,
  int arg3,
  const SolSignerSeeds * arg4,
  int
 arg5) {
  aeko_invoke_signed_c_pointer_type aeko_invoke_signed_c_pointer = (aeko_invoke_signed_c_pointer_type) 2720767109;
  return aeko_invoke_signed_c_pointer(arg1, arg2, arg3, arg4, arg5);
}
#endif
 ...
 */
static uint64_t aeko_invoke_signed(
    const SolInstruction *instruction,
    const AekoAccountInfo *account_infos,
    int account_infos_len,
    const SolSignerSeeds *signers_seeds,
    int signers_seeds_len
) {
  return aeko_invoke_signed_c(
    instruction,
    account_infos,
    account_infos_len,
    signers_seeds,
 ...
 * @param account_infos_len Length of account_infos array
*/
static uint64_t aeko_invoke(
    const SolInstruction *instruction,
    const AekoAccountInfo *account_infos,
    int account_infos_len
) {
  const SolSignerSeeds signers_seeds[] = {{}};
  return aeko_invoke_signed(
    instruction,
    account_infos,
    account_infos_len,
    signers_seeds,
