...
fn test_aeko_package(
    ...
    // Pass --sbf-out-dir along to the aeko-program-test crate
...
fn test_aeko(config: Config, manifest_path: Option<PathBuf>) {
...
fn main() {
    ...
    let matches = clap::Command::new(crate_name!())
        ...
        .arg(
            Arg::new("workspace")
                ...
                .takes_value(false)
                .alias("all")
                .help("Test all Aeko packages in the workspace"),
        )
        .arg(
            Arg::new("jobs")
                .short('j')
    ...
    test_aeko(config, manifest_path);
}
