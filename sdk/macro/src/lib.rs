...
impl Parse for SdkPubkey {
    fn parse(input: ParseStream) -> Result<Self> {
        parse_id(input, quote! { ::aeko_sdk::pubkey::Pubkey }).map(Self)
    }
}
...
impl Parse for ProgramSdkPubkey {
    fn parse(input: ParseStream) -> Result<Self> {
        parse_id(input, quote! { ::aeko_program::pubkey::Pubkey }).map(Self)
    }
}
...
impl ToTokens for Id {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        id_to_tokens(&self.0, quote! { ::aeko_sdk::pubkey::Pubkey }, tokens)
    }
}
...
impl ToTokens for IdDeprecated {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        deprecated_id_to_tokens(&self.0, quote! { ::aeko_sdk::pubkey::Pubkey }, tokens)
    }
}
...
impl ToTokens for ProgramSdkId {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        id_to_tokens(&self.0, quote! { ::aeko_program::pubkey::Pubkey }, tokens)
    }
}
...
impl ToTokens for ProgramSdkIdDeprecated {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        deprecated_id_to_tokens(&self.0, quote! { ::aeko_program::pubkey::Pubkey }, tokens)
    }
}
