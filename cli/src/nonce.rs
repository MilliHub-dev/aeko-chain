    ...
    fn nonce_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-nonce-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help(
                            "The amount to load the nonce account with, in AEKO; accepts keyword \
                             ALL",
                        ),
                )
                .arg(pubkey!(
        ...
        .subcommand(
            SubCommand::with_name("withdraw-from-nonce-account")
                .about("Withdraw AEKO from the nonce account")
                .arg(pubkey!(
                    Arg::with_name("nonce_account_pubkey")
                        .index(1)
                        .value_name("NONCE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .validator(is_amount)
                        .help("The amount to withdraw from the nonce account, in AEKO"),
                )
                .arg(nonce_authority_arg())
                .arg(memo_arg())
                .arg(compute_unit_price_arg()),
...
mod tests {
    ...
    fn test_check_nonce_account() {
        ...
        let nonce_pubkey = aeko_sdk::pubkey::new_rand();
        ...
        let new_nonce_authority = aeko_sdk::pubkey::new_rand();
        let data = Versions::new(State::Initialized(nonce::state::Data::new(
            new_nonce_authority,
            durable_nonce,
            0,
