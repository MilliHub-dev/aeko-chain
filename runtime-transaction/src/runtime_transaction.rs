...
//! aeko_sdk::SanitizedTransaction is client facing representation.
//!
//! It has two states:
//! 1. Statically Loaded: after receiving `packet` from sigverify and deserializing
//!    it into `aeko_sdk::VersionedTransaction`, then sanitizing into
//!    `aeko_sdk::SanitizedVersionedTransaction`, which can be wrapped into
...
use {
    ...
    aeko_program_runtime::compute_budget_processor::{
