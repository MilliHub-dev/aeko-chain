...
pub fn load_and_process_ledger(
    ...
    let account_paths = if let Some(account_paths) = arg_matches.value_of("account_paths") {
        // If this blockstore access is Primary, no other process (aeko-validator) can hold
        ...
        if !blockstore.is_primary_access() {
            ...
            // the Primary access instead of holding it to give priority to aeko-validator over
            // aeko-ledger-tool should aeko-validator start before we've finished.
            info!(
