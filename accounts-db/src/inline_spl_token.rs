...
use aeko_sdk::pubkey::{Pubkey, PUBKEY_BYTES};

aeko_sdk::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");

pub mod program_v3_4_0 {
    aeko_sdk::declare_id!("NToK4t5AQzxPNpUA84DkxgfXaVDbDQQjpHKCqsbY46B");
}
...
pub mod native_mint {
    aeko_sdk::declare_id!("So11111111111111111111111111111111111111112");
