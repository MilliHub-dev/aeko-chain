...
pub use {crate::extract_memos::extract_and_fmt_memos, aeko_sdk::reward_type::RewardType};
use {
    crate::{
...
/// Maps a list of inner instructions from `aeko_sdk` into a list of this
/// crate's representation of inner instructions (with instruction indices).
pub fn map_inner_instructions(
    inner_instructions: aeko_sdk::inner_instruction::InnerInstructionsList,
...
pub struct UiTransactionStatusMeta {
    ...
    pub status: TransactionResult<()>, // This field is deprecated.  See https://github.com/AEKO-labs/AEKO/issues/9302
    pub fee: u64,
    pub pre_balances: Vec<u64>,
    pub post_balances: Vec<u64>,
    #[serde(
