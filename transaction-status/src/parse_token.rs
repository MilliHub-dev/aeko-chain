use {
    ...
    aeko_account_decoder::parse_token::{token_amount_to_ui_amount, UiAccountState},
    aeko_sdk::{
...
pub fn spl_token_instruction(instruction: SplTokenInstruction) -> Instruction {
    Instruction {
        program_id: aeko_sdk::pubkey::Pubkey::new_from_array(instruction.program_id.to_bytes()),
        accounts: instruction
            .accounts
            .iter()
            .map(|meta| AccountMeta {
                pubkey: aeko_sdk::pubkey::Pubkey::new_from_array(meta.pubkey.to_bytes()),
...
mod test {
    use {
        super::*,
        aeko_sdk::{message::Message, pubkey::Pubkey},
    ...
    fn test_parse_token(program_id: &Pubkey) {
        ...
        let rent_sysvar = aeko_sdk::sysvar::rent::id();
        ...
        assert_eq!(
            ...
            ParsedInstructionEnum {
                ...
                info: json!({
                   ...
                   "systemProgram": aeko_sdk::system_program::id().to_string(),
                })
            }
        );
    }
    ...
    fn test_token_ix_not_enough_keys(program_id: &Pubkey) {
        let keys: Vec<Pubkey> = repeat_with(aeko_sdk::pubkey::new_rand).take(10).collect();
