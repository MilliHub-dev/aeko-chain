...
use {
    ...
    aeko_sdk::clock::Slot,
    aeko_transaction_status::EncodeError,
    thiserror::Error,
};

// Keep in sync with https://github.com/aeko-chain/solana-web3.js/blob/master/src/errors.ts
...
pub enum RpcCustomError {
    ...
    TransactionPrecompileVerificationFailure(aeko_sdk::transaction::TransactionError),
    #[error("SlotSkipped")]
