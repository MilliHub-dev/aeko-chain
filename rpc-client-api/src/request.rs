...
impl fmt::Display for RpcRequest {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let method = match self {
            ...
            RpcRequest::GetPostAnchor => "getPostAnchor",
            RpcRequest::GetPostsByCreator => "getPostsByCreator",
            RpcRequest::GetCreatorRewards => "getCreatorRewards",
            RpcRequest::GetCreatorRewardEpoch => "getCreatorRewardEpoch",
            RpcRequest::GetClaimableRewards => "getClaimableRewards",
            RpcRequest::SubmitEngagementProof => "submitEngagementProof",
            RpcRequest::GetEngagementScore => "getEngagementScore",
            RpcRequest::GetEngagementEvents => "getEngagementEvents",
            RpcRequest::GetReputationScore => "getReputationScore",
            RpcRequest::GetSocialStakePositions => "getSocialStakePositions",
            RpcRequest::StakeBehindCreator => "stakeBehindCreator",
            RpcRequest::UnstakeBehindCreator => "unstakeBehindCreator",
            RpcRequest::ClaimSocialStakeYield => "claimSocialStakeYield",
...
mod tests {
    use {
        ...
        aeko_sdk::commitment_config::{CommitmentConfig, CommitmentLevel},
    };
    ...
    fn test_build_request_json_config_options() {
        ...
        let mint = aeko_sdk::pubkey::new_rand();
