...
pub const CREATOR_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 5_000_000 * LAMPORTS_PER_AEKO,
    ...
    StakerInfo {
        ...
        lamports: 1_205_602 * LAMPORTS_PER_AEKO,
    ...
    StakerInfo {
        ...
        lamports: 3_655_292 * LAMPORTS_PER_AEKO,
    ...
    StakerInfo {
        ...
        lamports: 103_519 * LAMPORTS_PER_AEKO,
    ...
    StakerInfo {
        ...
        lamports: 3_880_295 * LAMPORTS_PER_AEKO,
...
pub const SERVICE_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 225_000 * LAMPORTS_PER_AEKO,
...
pub const FOUNDATION_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 57_500_000 * LAMPORTS_PER_AEKO,
...
pub const GRANTS_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 15_000_000 * LAMPORTS_PER_AEKO,
...
pub const COMMUNITY_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 30_301_032 * LAMPORTS_PER_AEKO,
    ...
    StakerInfo {
        ...
        lamports: 153_333_633 * LAMPORTS_PER_AEKO + 41 * LAMPORTS_PER_AEKO / 100,
...
pub fn add_genesis_accounts(genesis_config: &mut GenesisConfig, mut issued_lamports: u64) {
    ...
    create_and_add_stakes(
        ...
        &StakerInfo {
            ...
            lamports: (500_000_000 * LAMPORTS_PER_AEKO).saturating_sub(issued_lamports),
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        let clusters_and_expected_lamports = [
            (ClusterType::MainnetBeta, 500_000_000 * LAMPORTS_PER_AEKO),
            (ClusterType::Testnet, 500_000_000 * LAMPORTS_PER_AEKO),
            (ClusterType::Devnet, 500_000_000 * LAMPORTS_PER_AEKO),
