...
foreach ($dir in $dirs) {
    ...
    foreach ($file in $files) {
        ...
        $content = $content -replace 'aeko_clap_utils', 'aeko_clap_utils'
        $content = $content -replace 'aeko_remote_wallet', 'aeko_remote_wallet'
        $content = $content -replace 'aeko_send_transaction_service', 'aeko_send_transaction_service'
        ...
        $content = $content -replace 'aeko_banks_client', 'aeko_banks_client'
        $content = $content -replace 'aeko_banks_server', 'aeko_banks_server'
        $content = $content -replace 'aeko_banks_interface', 'aeko_banks_interface'
        $content = $content -replace 'aeko_test_validator', 'aeko_test_validator'
        $content = $content -replace 'aeko_program_test', 'aeko_program_test'
        $content = $content -replace 'aeko_bucket_map', 'aeko_bucket_map'
        $content = $content -replace 'aeko_merkle_tree', 'aeko_merkle_tree'
        $content = $content -replace 'aeko_merkle_root_bench', 'aeko_merkle_root_bench'
        $content = $content -replace 'aeko_lattice_hash', 'aeko_lattice_hash'
        $content = $content -replace 'aeko_download_utils', 'aeko_download_utils'
        $content = $content -replace 'aeko_bloom', 'aeko_bloom'
        $content = $content -replace 'aeko_accounts_db', 'aeko_accounts_db'
