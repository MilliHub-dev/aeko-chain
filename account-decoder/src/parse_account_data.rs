...
lazy_static! {
    ...
    static ref BPF_UPGRADEABLE_LOADER_PROGRAM_ID: Pubkey = aeko_sdk::bpf_loader_upgradeable::id();
    static ref CONFIG_PROGRAM_ID: Pubkey = aeko_config_program::id();
...
mod test {
    ...
    fn test_parse_account_data() {
        ...
        let other_program = aeko_sdk::pubkey::new_rand();
        let data = vec![0; 4];
