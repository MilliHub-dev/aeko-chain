use {
    ...
    bincode::deserialize,
    serde_json::Value,
    aeko_config_program::{get_config_data, ConfigKeys},
    aeko_sdk::{
        pubkey::Pubkey,
        stake::config::{
...
#[deprecated(
    since = "1.16.7",
    note = "Please use `aeko_sdk::stake::state::warmup_cooldown_rate()` instead"
)]
#[derive(Debug, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
mod test {
    use {
        ...
        aeko_config_program::create_config_account, aeko_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = aeko_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Aeko"}"#).unwrap(),
            }),
        );
