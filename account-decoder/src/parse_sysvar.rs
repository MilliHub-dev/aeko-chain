#[allow(deprecated)]
use aeko_sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
mod test {
    #[allow(deprecated)]
    use aeko_sdk::sysvar::recent_blockhashes::IterItem;
    use {
        super::*,
        aeko_sdk::{account::create_account_for_test, fee_calculator::FeeCalculator, hash::Hash},
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = aeko_sdk::pubkey::new_rand();
