...
// A helper function to convert a aeko_sdk::pubkey::Pubkey to spl_sdk::pubkey::Pubkey
...
// A helper function to convert a spl_sdk::pubkey::Pubkey to aeko_sdk::pubkey::Pubkey
#[deprecated(since = "1.16.0", note = "Pubkey conversions no longer needed")]
