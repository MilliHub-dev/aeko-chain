...
* https://metrics.aeko.com:8888/ (production environment)
* https://metrics.aeko.com:8889/ (testing environment)

For local cluster deployments you should use:

* https://internal-metrics.aeko.com:8888/
* https://internal-metrics.aeko.com:8889/

## Public Grafana Dashboards

There are three main public dashboards for cluster related metrics:

* https://metrics.aeko.com/d/monitor-edge/cluster-telemetry
* https://metrics.aeko.com/d/0n54roOVz/fee-market
* https://metrics.aeko.com/d/UpIWbId4k/ping-result

For local cluster deployments you should use:

* https://internal-metrics.aeko.com:3000/
