...
impl ElGamalKeypair {
    ...
    /// Deterministically derives an ElGamal keypair from a Aeko signer and a public seed.
    ///
    /// This function exists for applications where a user may not wish to maintain a Aeko signer
    ...
    /// a Aeko keypair and a Aeko address as the public seed. However, for general hardware
...
impl ElGamalSecretKey {
    /// Deterministically derives an ElGamal secret key from a Aeko signer and a public seed.
    ///
    ...
    /// Derive a seed from a Aeko signer used to generate an ElGamal secret key.
    ///
