...
impl AeKey {
    /// Deterministically derives an authenticated encryption key from a Aeko signer and a public
    /// seed.
    ///
    ...
    /// Derive a seed from a Aeko signer used to generate an authenticated encryption key.
    ///
