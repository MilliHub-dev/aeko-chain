...
use {
    ...
    aeko_vote_program::vote_state::{VoteAuthorize, VoteState, VoteStateVersions},
};
...
fn test_vote_authorize_and_withdraw() {
    ...
    let destination_account = aeko_sdk::pubkey::new_rand(); // Send withdrawal to new account to make balance check easy
