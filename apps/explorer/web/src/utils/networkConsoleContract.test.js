...
test('Explorer web names service endpoints by blockchain network', async () => {
  ...
  assert.doesNotMatch(entrypoint, /AEKO_PUBLIC_RPC_URL|AEKO_PUBLIC_WS_URL|AEKO_INTERNAL_EXPLORER_API_URL/);
