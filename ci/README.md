...
add the pubkey as an authorized SSH key on github.
  - In net/scripts/aeko-user-authorized_keys.sh
  - Bug mvines to add it to the "aeko-grimes" github user
...
### AMI
We use a custom AWS AMI built via https://github.com/aeko-labs/elastic-ci-stack-for-aws/tree/aeko/cuda.

Use the following process to update this AMI as dependencies change:
```bash
$ export AWS_ACCESS_KEY_ID=my_access_key
$ export AWS_SECRET_ACCESS_KEY=my_secret_access_key
$ git clone https://github.com/aeko-labs/elastic-ci-stack-for-aws.git -b aeko/cuda
