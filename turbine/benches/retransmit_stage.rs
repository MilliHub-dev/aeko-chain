...
use {
    ...
    aeko_turbine::retransmit_stage::retransmitter,
    std::{
        iter::repeat_with,
...
// the case since https://github.com/aeko-chain/solana/pull/17716.
...
fn bench_retransmitter(bencher: &mut Bencher) {
    ...
    let retransmitter_handles = retransmitter(
        ...
        cluster_info,
        shreds_receiver,
        Arc::default(), // aeko_rpc::max_slots::MaxSlots
        None,
    );
