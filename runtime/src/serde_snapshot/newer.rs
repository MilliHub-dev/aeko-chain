use {
    ...
    aeko_accounts_db::{accounts_hash::AccountsHash, ancestors::AncestorsForSerialization},
    aeko_measure::measure::Measure,
    aeko_sdk::{deserialize_utils::ignore_eof_error, stake::state::Delegation},
...
impl<'a> aeko_frozen_abi::abi_example::IgnoreAsHelper for SerializableVersionedBank<'a> {}
