...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        (aeko_stake_program::id(), aeko_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS),
        (aeko_config_program::id(), aeko_config_program::config_processor::DEFAULT_COMPUTE_UNITS),
        (aeko_vote_program::id(), aeko_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS),
        (aeko_system_program::id(), aeko_system_program::system_processor::DEFAULT_COMPUTE_UNITS),
        (compute_budget::id(), aeko_compute_budget_program::DEFAULT_COMPUTE_UNITS),
        (address_lookup_table::program::id(), aeko_address_lookup_table_program::processor::DEFAULT_COMPUTE_UNITS),
        (bpf_loader_upgradeable::id(), aeko_bpf_loader_program::UPGRADEABLE_LOADER_COMPUTE_UNITS),
        (bpf_loader_deprecated::id(), aeko_bpf_loader_program::DEPRECATED_LOADER_COMPUTE_UNITS),
        (bpf_loader::id(), aeko_bpf_loader_program::DEFAULT_LOADER_COMPUTE_UNITS),
        (loader_v4::id(), aeko_loader_v4_program::DEFAULT_COMPUTE_UNITS),
