...
use {
    ...
    aeko_bpf_loader_program::syscalls::{SyscallAbort, SyscallLog, SyscallMemcpy, SyscallMemset},
...
const BPF_LOADER_NAME: &str = "aeko_bpf_loader_program";
...
fn prepare_transactions(
    ...
    dir.push("tests");
    // File compiled from
    // https://github.com/aeko-developers/program-examples/blob/feb82f254a4633ce2107d06060f2d0558dc987f5/basics/hello-aeko/native/program/src/lib.rs
    dir.push("hello_aeko_program.so");
...
fn svm_integration() {
    ...
    let logs = result.execution_results[0]
        ...
        .as_ref()
        .unwrap();
    assert!(logs.contains(&"Program log: Hello, Aeko!".to_string()));
}
