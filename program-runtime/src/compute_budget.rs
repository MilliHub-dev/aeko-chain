use {
    ...
    aeko_sdk::{instruction::CompiledInstruction, pubkey::Pubkey, transaction::Result},
};

#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl ::aeko_frozen_abi::abi_example::AbiExample for ComputeBudget {
    fn example() -> Self {
...
pub struct ComputeBudget {
    ...
    /// program heap region size, default: aeko_sdk::entrypoint::HEAP_LENGTH
    pub heap_size: u32,
...
impl ComputeBudget {
    pub fn new(compute_unit_limit: u64) -> Self {
        ComputeBudget {
            ...
            heap_size: u32::try_from(aeko_sdk::entrypoint::HEAP_LENGTH).unwrap(),
