...
use {
    ...
    aeko_banks_client::BanksClient,
    aeko_program_test::{processor, ProgramTest, ProgramTestBanksClientExt, ProgramTestError},
    aeko_sdk::{
        account::Account,
...
async fn stake_rewards_filter_bench_core(num_stake_accounts: u64) {
    ...
    // create stake accounts with 0.9 aeko to test min-stake filtering
    const TEST_FILTER_STAKE: u64 = 900_000_000; // 0.9 aeko
