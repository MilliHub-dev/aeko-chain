...
/// Unique program ID for the revocation-registry.
pub const REVOCATION_REGISTRY_PROGRAM_ID_BYTES: [u8; 32] = [18u8; 32];

pub fn id() -> Pubkey {
    Pubkey::new_from_array(REVOCATION_REGISTRY_PROGRAM_ID_BYTES)
}
