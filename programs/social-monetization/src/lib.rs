...
pub const DEFAULT_COMPUTE_UNITS: u64 = 180;
pub const SOCIAL_MONETIZATION_PROGRAM_ID_BYTES: [u8; 32] = [15u8; 32];

pub fn id() -> Pubkey {
    Pubkey::new_from_array(SOCIAL_MONETIZATION_PROGRAM_ID_BYTES)
}
