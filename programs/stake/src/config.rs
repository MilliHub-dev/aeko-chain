...
#[allow(deprecated)]
use aeko_sdk::stake::config;
#[deprecated(
    since = "1.8.0",
    note = "Please use `aeko_sdk::stake::config` or `aeko_program::stake::config` instead"
)]
pub use aeko_sdk::stake::config::*;
use {
    bincode::deserialize,
    aeko_config_program::{create_config_account, get_config_data},
    aeko_sdk::{
