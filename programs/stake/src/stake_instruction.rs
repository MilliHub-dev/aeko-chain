...
mod tests {
    use {
        ...
        aeko_vote_program::vote_state::{self, VoteState, VoteStateVersions},
                ...
                (
                    *pubkey,
                    if clock::check_id(pubkey) {
                        ...
                        AccountSharedData::new(0, 0, &aeko_vote_program::id())
    ...
    fn test_stake_process_instruction_decode_bail(feature_set: Arc<FeatureSet>) {
        ...
        let vote_account = AccountSharedData::new(0, 0, &aeko_vote_program::id());
    ...
    fn test_stake_initialize(feature_set: Arc<FeatureSet>) {
        ...
        let stake_address = aeko_sdk::pubkey::new_rand();
        let stake_account = AccountSharedData::new(stake_lamports, StakeStateV2::size_of(), &id());
        let custodian_address = aeko_sdk::pubkey::new_rand();
        let lockup = Lockup {
            epoch: 1,
            unix_timestamp: 0,
    ...
    fn test_authorize(feature_set: Arc<FeatureSet>) {
        let authority_address = aeko_sdk::pubkey::new_rand();
        let authority_address_2 = aeko_sdk::pubkey::new_rand();
        let stake_address = aeko_sdk::pubkey::new_rand();
        ...
        .unwrap();
        let to_address = aeko_sdk::pubkey::new_rand();
    ...
    fn test_authorize_override(feature_set: Arc<FeatureSet>) {
        let authority_address = aeko_sdk::pubkey::new_rand();
        let mallory_address = aeko_sdk::pubkey::new_rand();
        let stake_address = aeko_sdk::pubkey::new_rand();
        let stake_lamports = 42;
        let stake_account = AccountSharedData::new_data_with_space(
            stake_lamports,
    ...
    fn test_authorize_with_seed(feature_set: Arc<FeatureSet>) {
        let authority_base_address = aeko_sdk::pubkey::new_rand();
        let authority_address = aeko_sdk::pubkey::new_rand();
        let seed = "42";
    ...
    fn test_authorize_delegated_stake(feature_set: Arc<FeatureSet>) {
        ...
        .unwrap();
        let vote_address = aeko_sdk::pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &aeko_sdk::pubkey::new_rand(), 0, 100);
        let vote_address_2 = aeko_sdk::pubkey::new_rand();
        let mut vote_account_2 =
            vote_state::create_account(&vote_address_2, &aeko_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_stake_delegate(feature_set: Arc<FeatureSet>) {
        ...
        transaction_accounts[1]
            .1
            .set_owner(aeko_sdk::pubkey::new_rand());
        process_instruction(
            Arc::clone(&feature_set),
            &serialize(&StakeInstruction::DelegateStake).unwrap(),
            transaction_accounts.clone(),
            instruction_accounts.clone(),
            Err(aeko_sdk::instruction::InstructionError::IncorrectProgramId),
        );
    ...
    fn test_redelegate_consider_balance_changes(feature_set: Arc<FeatureSet>) {
        ...
        let recipient_address = aeko_sdk::pubkey::new_rand();
        let authority_address = aeko_sdk::pubkey::new_rand();
        let vote_address = aeko_sdk::pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &aeko_sdk::pubkey::new_rand(), 0, 100);
    ...
    fn test_split(feature_set: Arc<FeatureSet>) {
        ...
        let split_to_address = aeko_sdk::pubkey::new_rand();
    ...
    fn test_set_lockup(feature_set: Arc<FeatureSet>) {
        let custodian_address = aeko_sdk::pubkey::new_rand();
        let authorized_address = aeko_sdk::pubkey::new_rand();
        let stake_address = aeko_sdk::pubkey::new_rand();
        let minimum_delegation = crate::get_minimum_delegation(&feature_set);
        let stake_lamports = minimum_delegation;
        let stake_account = AccountSharedData::new_data_with_space(
    ...
    fn test_merge(feature_set: Arc<FeatureSet>) {
        let stake_address = aeko_sdk::pubkey::new_rand();
        let merge_from_address = aeko_sdk::pubkey::new_rand();
        let authorized_address = aeko_sdk::pubkey::new_rand();
    ...
    fn test_merge_incorrect_authorized_staker(feature_set: Arc<FeatureSet>) {
        ...
        let merge_from_address = aeko_sdk::pubkey::new_rand();
        let authorized_address = aeko_sdk::pubkey::new_rand();
        let wrong_authorized_address = aeko_sdk::pubkey::new_rand();
        let stake_lamports = 42;
        let mut instruction_accounts = vec![
            AccountMeta {
                pubkey: stake_address,
