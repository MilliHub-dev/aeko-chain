...
/// Unique program ID for the subnet-registry.
pub const SUBNET_REGISTRY_PROGRAM_ID_BYTES: [u8; 32] = [19u8; 32];

pub fn id() -> Pubkey {
    Pubkey::new_from_array(SUBNET_REGISTRY_PROGRAM_ID_BYTES)
}
