...
/// Unique program ID for the finality-oracle.
pub const FINALITY_ORACLE_PROGRAM_ID_BYTES: [u8; 32] = [21u8; 32];

pub fn id() -> Pubkey {
    Pubkey::new_from_array(FINALITY_ORACLE_PROGRAM_ID_BYTES)
}
