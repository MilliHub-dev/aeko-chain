...
// Copyright 2020 Aeko Maintainers <maintainers@aeko.chain>
//
...
fn test_reloc_64_relative_data_sbpfv1() {
    // Before https://github.com/aeko-chain/llvm-project/pull/35, we used to
...
fn execute_generated_program(prog: &[u8]) -> bool {
    ...
    {
        let analysis =
            aeko_rbpf::static_analysis::Analysis::from_executable(&executable).unwrap();
