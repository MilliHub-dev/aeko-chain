...
[![Build Status](https://github.com/aeko-chain/rbpf/actions/workflows/main.yml/badge.svg)](https://github.com/aeko-chain/rbpf/actions/workflows/main.yml)
[![Crates.io](https://img.shields.io/crates/v/aeko_rbpf.svg)](https://crates.io/crates/aeko_rbpf)
...
This crate is available from [crates.io](https://crates.io/crates/aeko_rbpf),
...
```toml
[dependencies]
aeko_rbpf = { git = "https://github.com/aeko-chain/rbpf", branch = "main" }
```
...
here](https://docs.rs/aeko_rbpf/), automatically generated from the
[crates.io](https://crates.io/crates/aeko_rbpf)
