...
impl Processor {
    ...
    pub fn process_close_account(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
        ...
        } else if !aeko_program::incinerator::check_id(destination_account_info.key) {
            return Err(ProgramError::InvalidAccountData);
        }
...
fn delete_account(account_info: &AccountInfo) -> Result<(), ProgramError> {
    ...
    aeko_program::program_memory::sol_memset(*account_data, 0, data_len);
    Ok(())
}
...
mod tests {
    ...
    impl solana_sdk::program_stubs::SyscallStubs for SyscallStubs {
        ...
        fn sol_get_rent_sysvar(&self, var_addr: *mut u8) -> u64 {
            ...
            aeko_program::entrypoint::SUCCESS
        }
    ...
    fn test_burn_and_close_system_and_incinerator_tokens() {
        ...
        do_process_instruction(
            initialize_account3(
                ...
                &system_account_key,
                &mint_key,
                &aeko_program::system_program::id(),
            )
            .unwrap(),
