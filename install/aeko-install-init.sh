...
# install aeko-install. It just does platform detection, downloads the installer
# and runs it.
...
USAGE:
    aeko-install-init [FLAGS] [OPTIONS] --data_dir <PATH> --pubkey <PUBKEY>
...
OPTIONS:
    ...
    -u, --url <URL>          JSON RPC URL for the aeko cluster
