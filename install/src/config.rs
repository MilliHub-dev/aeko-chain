...
mod test {
    ...
    fn test_save() {
        ...
        let json_rpc_url = "https://rpc.example.invalid";
        ...
        assert_eq!(
            ...
            format!(
                "---
json_rpc_url: https://rpc.example.invalid
...
"
    ...
    fn test_load_serde_yaml_v_0_8_config() {
        ...
        let root_dir = "/home/aeko/.local/share/aeko/install";
...
"
        ...
        assert_eq!(
            config,
            Config {
                json_rpc_url: String::from("https://rpc.example.invalid"),
