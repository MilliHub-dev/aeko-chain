use {
    ...
    aeko_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    aeko_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, aeko_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = aeko_sdk::pubkey::new_rand();
        let k2 = aeko_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.set_pubkey(aeko_sdk::pubkey::new_rand());
        }
        let slot = 9;
