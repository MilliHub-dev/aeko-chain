...
mod tests {
    use {
        ...
        aeko_gossip::{contact_info::ContactInfo, socketaddr, socketaddr_any},
        aeko_ledger::{
        ...
        aeko_perf::packet::{deserialize_from_with_limit, Packet},
    ...
    fn test_serialize_deserialize_signed_request() {
        ...
        let repair_peer_id = aeko_sdk::pubkey::new_rand();
    ...
    fn test_repair_with_repair_validators() {
        ...
        for pubkey in &[aeko_sdk::pubkey::new_rand(), *me.pubkey()] {
