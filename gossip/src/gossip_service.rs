...
pub fn discover(
    ...
    let _ip_echo_server = ip_echo
        .map(|tcp_listener| aeko_net_utils::ip_echo_server(tcp_listener, Some(my_shred_version)));
...
mod tests {
    ...
    fn test_gossip_services_spy() {
        ...
        let peer0 = aeko_sdk::pubkey::new_rand();
        let peer1 = aeko_sdk::pubkey::new_rand();
