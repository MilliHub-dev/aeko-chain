...
pub struct LegacyVersion {
    pub from: Pubkey,
    pub wallclock: u64,
    pub version: aeko_version::LegacyVersion1,
}
...
pub struct Version {
    pub from: Pubkey,
    pub wallclock: u64,
    pub version: aeko_version::LegacyVersion2,
}
...
impl Version {
    pub fn new(from: Pubkey) -> Self {
        Self {
            from,
            wallclock: timestamp(),
            version: aeko_version::LegacyVersion2::default(),
        }
    }
    ...
    fn new_rand<R: Rng>(rng: &mut R, pubkey: Option<Pubkey>) -> Self {
        Self {
            from: pubkey.unwrap_or_else(pubkey::new_rand),
            wallclock: new_rand_timestamp(rng),
            version: aeko_version::LegacyVersion2 {
                major: rng.gen(),
                minor: rng.gen(),
                patch: rng.gen(),
                commit: Some(rng.gen()),
...
mod test {
    use {
        ...
        aeko_vote_program::{vote_instruction, vote_state},
