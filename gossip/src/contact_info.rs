...
pub use {
    crate::legacy_contact_info::LegacyContactInfo, aeko_client::connection_cache::Protocol,
};
...
impl ContactInfo {
    pub fn new(pubkey: Pubkey, wallclock: u64, shred_version: u16) -> Self {
        Self {
            ...
            shred_version,
            version: aeko_version::Version::default(),
...
impl aeko_frozen_abi::abi_example::AbiExample for ContactInfo {
    fn example() -> Self {
        Self {
            ...
            version: aeko_version::Version::example(),
